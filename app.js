...
function multiply(a,b){ //eslint-disable-line
  var tot = a * b;
  var message = 'The product of ' + a + ' and ' + b + ' is ' + tot + '.';
  return [tot, message];
}
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var themultiply = multiply(multiply(a,b)[0],c)[0];
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + theSum + '.';
  var multiplyMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + themultiply + '.';
  return [theSum, themultiply, sumMessage, multiplyMessage];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var one = multiply(multiply(testArray[0],testArray[1])[0],testArray[2])[0];
  var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + one + '.';
  return [one, message];
}
